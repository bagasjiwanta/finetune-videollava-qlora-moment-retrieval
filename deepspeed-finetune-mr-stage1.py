...
if __name__ == "__main__":
    ...
    try:
        ...
        dataset = None
    if dataset is None:
        dataset = dp.prepare_dataset(use_robust=True)

    train_dataset = dataset['train'].select(range(640))
    eval_dataset = dataset['validation'].select(range(Config.limit_val_batches))
